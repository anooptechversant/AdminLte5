                ...
                >
                  <div className="size-12.5 rounded-full">
                    <Image
                      width={112}
                      height={112}
                      src={`${process.env.NEXT_PUBLIC_BASE_PATH}/images/user/user-02.png`}
                      alt="User"
                      style={{
                        width: 'auto',
                        height: 'auto',
                ...
                >
                  <div className="size-12.5 rounded-full">
                    <Image
                      width={112}
                      height={112}
                      src={`${process.env.NEXT_PUBLIC_BASE_PATH}/images/user/user-03.png`}
                      alt="User"
                      style={{
                        width: 'auto',
                        height: 'auto',
                ...
                >
                  <div className="size-12.5 rounded-full">
                    <Image
                      width={112}
                      height={112}
                      src={`${process.env.NEXT_PUBLIC_BASE_PATH}/images/user/user-04.png`}
                      alt="User"
                      style={{
                        width: 'auto',
                        height: 'auto',
