...
const Brand = ({ Data, Success, Error, Loading, isActiveData }) => {
  ...
  const loadingBrand = Loading;
  const pageTitle = "Brand";
  const tableTitle = "Brand";
  const addTableTitle = "Add Brand";
  const deleteConfirmMessage = "Are you sure you want to delete this Brand?";
